...
#define serverIP        "212.192.134.141"
#define IOT_CLIENT      "dfrobot"
#define IOT_USERNAME    "homeassistant"
#define IOT_KEY         "up4IxZQaVLvxSeYbzRkJ"
#define IOT_TOPIC       "test/some_topic1"
...
void setup(){
  ...
  // mySerial.println("AT+SAPBR=3,1,\"APN\",\"internet,mts.ru");
...
void loop(){
  ...
  Serial.println(" ......");
  if(sim7000.mqttPublish(IOT_TOPIC,"10")){                 //Send data to topic
